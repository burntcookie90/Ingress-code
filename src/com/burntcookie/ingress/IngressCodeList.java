	...
	private void loadFeed(ParserType type){
    	try{
	    	...
	    	for (Message msg : messages){
	    		if(msg.getTitle().toLowerCase().contains("passcode") || msg.getTitle().toLowerCase().contains("new code") || (msg.getTitle().toLowerCase().contains("code") && !msg.getTitle().toLowerCase().contains("activation"))){
